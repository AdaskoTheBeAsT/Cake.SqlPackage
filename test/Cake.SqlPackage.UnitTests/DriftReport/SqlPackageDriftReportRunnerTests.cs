...
{
    public sealed class SqlPackageDriftReportRunnerTests
    {
        public sealed class TheRunMethod
        {
            private readonly SqlPackageDriftReportFixture _fixture;

            public TheRunMethod()
            {
                _fixture = new SqlPackageDriftReportFixture();
            }
            ...
            public void Should_Add_Action_If_Provided()
            {
                ...
                // Then
                Assert.Equal("/Action:DriftReport", result.Args);
            }
            ...
            public void Should_Add_OutputPath_If_Provided()
            {
                ...
                // Then
                Assert.Equal("/Action:DriftReport /OutputPath:\"/Working/artifacts\"", result.Args);
            }
            ...
            public void Should_Add_Overwrite_Files_If_Provided()
            {
                ...
                // Then
                Assert.Equal("/Action:DriftReport /OverwriteFiles:True", result.Args);
            }
            ...
            public void Should_Add_Quiet_If_Provided()
            {
                ...
                // Then
                Assert.Equal("/Action:DriftReport /Quiet:True", result.Args);
            }
            ...
            public void Should_Add_Target_Connection_String_If_Provided()
            {
                ...
                // Then
                Assert.Equal("/Action:DriftReport /TargetConnectionString:\"Data Target=(LocalDB)\\v11.0;AttachDbFileName=|DataDirectory|\\DatabaseFileName.mdf;InitialCatalog=DatabaseName;Integrated Security=True;MultipleActiveResultSets=True\"", result.Args);
            }
            ...
            public void Should_Add_Tenant_Id_Provided()
            {
                ...
                // Then
                Assert.Equal("/Action:DriftReport /TenantId:10", result.Args);
            }
            ...
            public void Should_Add_Universal_Authentication_Provided()
            {
                ...
                // Then
                Assert.Equal("/Action:DriftReport /UniversalAuthentication:True", result.Args);
            }
            ...
            public void Should_Add_Properties_If_Provided(string key, string value)
            {
                ...
                // Then
                Assert.Equal($"/Action:DriftReport /p:{key}={value}", result.Args);
            }
