...
namespace Cake.SqlPackage.UnitTests
{
    public sealed class SqlPackageDeployReportRunnerTests
    {
        ...
        {
            private readonly SqlPackageDeployReportFixture _fixture;

            public TheRunMethod()
            {
                _fixture = new SqlPackageDeployReportFixture();
            }
            ...
            {
                // Given
                _fixture.Settings.SourceFile = "./sqlDeployReportprofile.pubxml";
            ...
            {
                // Given
                _fixture.Settings.TargetFile = "./sqlDeployReportprofile.pubxml";
