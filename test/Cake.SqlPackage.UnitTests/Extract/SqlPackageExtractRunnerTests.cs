...
{
    public sealed class SqlPackageExtractRunnerTests
    {
        public sealed class TheRunMethod
        {
            private readonly SqlPackageExtractFixture _fixture;

            public TheRunMethod()
            {
                _fixture = new SqlPackageExtractFixture();
            }
            ...
            public void Should_Add_Action_If_Provided()
            {
                ...
                // Then
                Assert.Equal("/Action:Extract", result.Args);
            }
            ...
            public void Should_Add_OutputPath_If_Provided()
            {
                ...
                // Then
                Assert.Equal("/Action:Extract /OutputPath:\"/Working/artifacts\"", result.Args);
            }
            ...
            public void Should_Add_Overwrite_Files_If_Provided()
            {
                ...
                // Then
                Assert.Equal("/Action:Extract /OverwriteFiles:True", result.Args);
            }
            ...
            public void Should_Add_Quiet_If_Provided()
            {
                ...
                // Then
                Assert.Equal("/Action:Extract /Quiet:True", result.Args);
            }
            ...
            public void Should_Add_Target_File_If_Provided()
            {
                ...
                // Then
                Assert.Equal("/Action:Extract /TargetFile:\"/Working/sqlpublishprofile.pubxml\"", result.Args);
            }
            ...
            public void Should_Add_Tenant_Id_Provided()
            {
                ...
                // Then
                Assert.Equal("/Action:Extract /TenantId:10", result.Args);
            }
            ...
            public void Should_Add_Properties_If_Provided(string key, string value)
            {
                ...
                // Then
                Assert.Equal($"/Action:Extract /p:{key}={value}", result.Args);
            }
