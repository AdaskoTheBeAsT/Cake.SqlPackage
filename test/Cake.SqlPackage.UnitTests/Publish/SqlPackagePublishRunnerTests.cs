...
namespace Cake.SqlPackage.UnitTests
{
    public sealed class SqlPackagePublishRunnerTests
    {
        ...
        {
            private readonly SqlPackagePublishFixture _fixture;

            public TheRunMethod()
            {
                _fixture = new SqlPackagePublishFixture();
            }
            ...
            {
                // Given
                _fixture.Settings.AzureKeyVaultAuthMethod = AzureKeyVaultAuthMethod.Interactive;
            ...
            {
                // Given
                _fixture.Settings.AzureSecret = "banana";
