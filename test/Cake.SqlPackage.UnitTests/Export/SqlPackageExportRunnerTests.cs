...
{
    public sealed class SqlPackageExportRunnerTests
    {
        public sealed class TheRunMethod
        {
            private readonly SqlPackageExportFixture _fixture;

            public TheRunMethod()
            {
                _fixture = new SqlPackageExportFixture();
            }
            ...
            public void Should_Add_OutputPath_If_Provided()
            {
                ...
                // Then
                Assert.Equal("/Action:Export /OutputPath:\"/Working/artifacts\"", result.Args);
            }
            ...
            public void Should_Add_Overwrite_Files_If_Provided()
            {
                ...
                // Then
                Assert.Equal("/Action:Export /OverwriteFiles:True", result.Args);
            }
            ...
            public void Should_Add_Quiet_If_Provided()
            {
                ...
                // Then
                Assert.Equal("/Action:Export /Quiet:True", result.Args);
            }
            ...
            public void Should_Add_Source_Connection_String_If_Provided()
            {
                ...
                // Then
                Assert.Equal("/Action:Export /SourceConnectionString:\"Data Source=(LocalDB)\\v11.0;AttachDbFileName=|DataDirectory|\\DatabaseFileName.mdf;InitialCatalog=DatabaseName;Integrated Security=True;MultipleActiveResultSets=True\"", result.Args);
            }
            ...
            public void Should_Add_Target_File_If_Provided()
            {
                ...
                // Then
                Assert.Equal("/Action:Export /TargetFile:\"/Working/sqlpublishprofile.pubxml\"", result.Args);
            }
            ...
            public void Should_Add_Properties_If_Provided(string key, string value)
            {
                ...
                // Then
                Assert.Equal($"/Action:Export /p:{key}={value}", result.Args);
            }
